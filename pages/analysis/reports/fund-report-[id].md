...
# Quarterly Report — {fund_key_metrics[0].fund_name}

This is a short report example. Report templates can be customized and extended.

<ExportToWordButton pageTitle="Quarterly Report" buttonText="Download Report"/>
